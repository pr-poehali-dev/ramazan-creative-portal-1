            ...
            <div className="lg:w-1/2">
              <div className="relative flex flex-col items-center">
                ...
                <div className="backdrop-blur-md rounded-xl p-8 text-center border-2 border-gold/30 shadow-2xl bg-[#b8860b]">
                  <blockquote className="text-lg text-white font-openSans leading-relaxed font-bold drop-shadow-lg mx-0 px-0 my-0 rounded-none text-center">"Настоящий лидер должен не только управлять, но и вдохновлять, не только решать проблемы настоящего, но и создавать основы для будущих поколений. 

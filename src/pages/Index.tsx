...
const Index = () => {
  ...
  const paintings = [
    ...
    },
    {
      ...
      interiorImages: [
        {
          title: "В элегантной гостиной с теплым освещением",
          description: "Картина создает уютную атмосферу в интерьере с мягким желтым креслом и натуральными материалами",
          image: "https://cdn.poehali.dev/files/38a94ab7-3885-4dc8-a97b-b2548461ee2e.jpg"
        }
      ]
    },
    {
      ...
      interiorImages: [
        {
          title: "В стильной гостиной с панорамным видом",
          description: "Картина создает яркий акцент в элегантном интерьере с изумрудными и оранжевыми тонами",
          image: "https://cdn.poehali.dev/files/9533d46c-e7b9-4b34-b026-06897d8e1fb1.jpg"
        }
      ]
    },
    {
      ...
      interiorImages: [
        {
          title: "В офисе с панорамными окнами",
          description: "Картина добавляет яркие краски в современный офисный интерьер с изумрудной мебелью",
          image: "https://cdn.poehali.dev/files/2977e6b6-a8ef-4921-b498-33aa00d6033e.jpg"
        }
      ]
    },
    {
      ...
      interiorImages: [
        {
          title: "В уютной домашней библиотеке",
          description: "Картина прекрасно дополняет теплый интерьер с деревянными элементами и желтым акцентным креслом",
          image: "https://cdn.poehali.dev/files/87bf040f-6abc-43cb-adf7-5de68483383e.jpg"
        }
      ]
    },
    {
  ...
  const timeline = [
    ...
    },
    {
      year: "1960-е",
      title: "Образование",
      description: "Поступил на исторический факультет Дагестанского государственного университета. Изучал философию и политологию, активно участвовал в общественной жизни"
    },
    {
      year: "1991-2006",
  ...
  return (
    <div className="min-h-screen bg-lightGray">
      ...
      {/* Hero Section */}
      <section className="from-darkGray to-gray-800 text-white py-20 bg-[#01022af5]">
            ...
            <div className="lg:w-1/2">
              <div className="relative flex flex-col items-center">
                ...
                <div className="backdrop-blur-md rounded-xl p-8 text-center border-2 border-gold/30 shadow-2xl bg-[#b8860b]">
                  <blockquote className="text-lg text-white font-openSans leading-relaxed drop-shadow-lg mx-0 px-0 my-0 rounded-none text-center font-semibold">"Настоящий лидер должен не только управлять, но и вдохновлять, не только решать проблемы настоящего, но и создавать основы для будущих поколений. 
Культура и образование — это фундамент любого прогресса.</blockquote>
      ...
      <section className="py-16 from-amber-50 to-yellow-50 bg-[#ffffff]">
        <div className="container mx-auto px-6">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-700 max-w-4xl mx-auto font-openSans leading-relaxed">Уникальное сочетание государственной деятельности, литературного творчества, художественного мастерства и музыкального таланта. </p>
          </div>
        </div>
      </section>

      {/* Biography Section */}
      <section id="biography" className="py-20 bg-[#b8860b1a]">
        <div className="container mx-auto px-6 bg-[#ffffff1a]">
      ...
      <section id="dagestan" className="pt-8 pb-20 bg-white">
        <div className="container mx-auto px-6 bg-[#fbfbfb1a]">
          <div className="max-w-4xl mx-auto text-center bg-[#f9f9f91a]">
            <h2 className="text-4xl font-bold mb-6 font-cormorant text-darkGray">Деятельность в Дагестане</h2>

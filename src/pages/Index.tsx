          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2">
              <h1 className="text-5xl lg:text-6xl font-bold mb-6 font-cormorant -mt-4 text-left">
                ...
                <span className="block text-gold px-0 my-0 mx-0 text-6xl">Абдулатипов</span>
              </h1>
...
Культура и образование — это фундамент любого прогресса.</blockquote>
                  <cite className="font-cormorant drop-shadow-lg text-3xl font-black text-[#fffdf9]">- Рамазан А б д у л а т и п о в</cite>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="creative" className="py-20 bg-[#f8f9fa]">
        <div className="container mx-auto px-6 bg-[#b8860b1a]">
          <h2 className="text-4xl font-bold text-center mb-4 font-cormorant text-darkGray">
            Творческое наследие
          </h2>
